          ...
          <div className="mt-10 md:mt-20 lg:mt-24 grid sm:grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-x-4 text-center items-center">
            ...
            <div className=" p-4 md:col-span-5 lg:col-span-5">
              ...
              <div className="bg-white py-8 lg:py-16 px-4 mx-auto max-w-screen-md rounded-lg">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 sm:text-xl">Get your free quote/Any feedback</p>
                ...
                <form action="#" className="">
                  <div>
                    ...
                    <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="name@jpporjects.com" required />
                  </div>
                  <div>
                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 mt-4">Name</label>
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 mt-4">Your message</label>
                  ...
                  <button type="submit" className="py-3 px-5 mt-4 text-sm font-medium text-center bg-primary text-secondary rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</button>
                </form>
              </div>
