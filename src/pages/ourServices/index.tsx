    ...
    <div className="container sm:mt-10 md:mt-12 lg:mt-24">
      ...
      <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sed
                    ante justo. Integer euismod libero id mauris malesuada tincidunt. dsjosifj oidsfjodf dosdifj odfosdfifdo fsdofdo</p>
                <div className="flex items-center justify-between mt-4">
                   
                    <button className="mt-0 bg-primary text-white py-2 px-5 rounded-full font-bold hover:bg-gray-800">Read more</button>
                </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="relative overflow-hidden">
