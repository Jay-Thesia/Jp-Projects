...
const Footer = () => {
    return (
        <footer className="w-full bg-primary text-white  mt-12 sm:mt-14 md:mt-20 lg:mt-28">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                {/* <!--Grid--> */}
                <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">


                    <div className="block text-center  xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
                        <h4 className="text-lg font-bold mb-9">Get In Touch</h4>
                        <ul className=" transition-all duration-500 grid gap-4">
                            <a href='mailto:jpproject.jitendr@gmail.com'>jpproject.jitendr@gmail.com</a>
                    ...
                    <div className="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-6 text-center">
                        <h4 className="text-lg font-bold mb-9 ">Quick Links</h4>
                        <div className="flex gap-6 lg:gap-12 xl:gap-12 justify-center lg:text-center">
                    ...
                    <div className="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
                        <h4 className="text-lg font-bold mb-9 text-center ">Social Media</h4>
                        <div className="flex  space-x-4 md:space-x-2 justify-center">
                            <a href="javascript:;"
                                className="w-9 h-9 rounded-full bg-slate-700 flex justify-center items-center hover:bg-gray-50">
                            ...
                            <a href="javascript:;"
                                className="w-9 h-9 rounded-full bg-slate-700 flex justify-center items-center hover:shadow-md">
                            ...
                            <a href="#" className="w-9 h-9 rounded-full bg-slate-700 flex justify-center items-center hover:shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.2" baseProfile="tiny" x="0px" y="0px" width="36px" height="20px" viewBox="0 5 36 36" xmlSpace="preserve">
                                    <defs>
                                    </defs>
                                    {/* <rect fill="#5C55aB" width="36" height="36" /> */}
                                    <path fill="#D9B27F" d="M30.895,16.535l-0.553,5.23h-4.181v15.176h-6.28V21.766H16.75v-5.23h3.131v-3.149  c0-4.254,1.768-6.796,6.796-6.796h4.181v5.23h-2.615c-1.952,0-2.081,0.736-2.081,2.1v2.615H30.895z" />
                                </svg>
                            </a>

                            <a href="" className="w-9 h-9 rounded-full bg-slate-700 flex justify-center items-center hover:shadow-md">

                                <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" width="36px" height="24px" viewBox="0 0 417 512.238"><path fill="#D9B27F" fillRule="nonzero" d="M171.274 344.942h74.09v167.296h-74.09V344.942zM0 173.468h126.068l-89.622-85.44 49.591-50.985 85.439 87.829V0h74.086v124.872L331 37.243l49.552 50.785-89.58 85.24H417v70.502H290.252l90.183 87.629L331 381.192 208.519 258.11 86.037 381.192l-49.591-49.591 90.218-87.631H0v-70.502z" /></svg>
                            </a>
                        </div>
                    </div>
            ...
            <div className="py-4 bg-indigo-50">
                <div className="flex items-center justify-center">
                    <span className="text-sm text-gray-800 text-center ">Copyright@2024 All Right Reserved  by <a href="https://pagedone.io/">J.P. Projects</a></span>
                </div>
            </div>
