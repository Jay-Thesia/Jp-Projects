    ...
    <footer className="w-full bg-primary text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
            ...
            <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
                ...
                <div className="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
                    <h4 className="text-lg font-bold mb-9 text-center ">Quick Links</h4>
                    <div className="flex gap-6 xl:gap-12 max-xl:justify-center">
                        <ul className="text-center transition-all duration-500 grid gap-6">
                ...
                <div className="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
                    <h4 className="text-lg font-bold mb-9 text-center xl:text-left">Social Media</h4>
        ...
        <div className="py-4 bg-indigo-50">
            <div className="flex items-center justify-center">
                <span className="text-sm text-gray-800 ">Copyright@2024 All Right Reserved  by <a href="https://pagedone.io/">J.P. Projects</a></span>
            </div>
        </div>
